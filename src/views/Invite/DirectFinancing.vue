<template>
    <PageLayoutTab title="Invite">
        <div class="flex flex-col gap-[.2rem] w-screen h-[calc(100vh-1.7rem)] bg-[#05309F] text-white p-[.2rem]">
            ...
            <div class="flex flex-col h-[calc(100vh-4.3rem)] overflow-auto">
                <div v-for="( financingValue, indexes) in FinancingData?.content?.rows" :key=indexes
                    ...
                    <div
                        ...
                        <span class="text-[.15rem] text-white">V{{ financingValue.level }}</span>
                    </div>
                    <div class="grid grid-cols-2 gap-[.2rem]">
                        <div class="flex flex-col gap-[.1rem]">
                            <div class="flex items-center gap-[.1rem]">
                                <span class="flex items-center text-[#fff] text-[.2rem]">{{ financingValue.promotionCode
                                    ? financingValue.promotionCode : "-" }}</span>
                                <span class="flex items-center text-[#fff] text-[.2rem]"><img
                                        src="/copyIcons/Cartier_copy.png" alt="" class="w-[.3rem]"></span>
                            </div>
                            <div class="flex items-center gap-[.1rem]">
                                <span class="flex items-center text-[#fff] text-[.2rem]">Deposit {{
                                    financingValue.depositTimes ? financingValue.depositTimes : "0" }} (times)</span>
                            </div>
                            <div class="flex flex-col gap-[.1rem] justify-end">
                                <div class="flex items-center gap-[.1rem]">
                                    <span class="flex items-center text-[#fff] text-[.2rem]">Price difference</span>
                                    <span class="flex items-center text-[#04be02] text-[.2rem]">-{{ financingValue.totalMoney - financingValue.totalDrawMoney }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="flex flex-col gap-[.1rem] justify-end">
                            <div class="flex items-center gap-[.1rem]">
                                <span class="flex items-center text-[#fff] text-[.2rem]">Withdrawal</span>
                                <span class="flex items-center text-[#fff] text-[.2rem]">{{
                                    financingValue.totalDrawMoney ? financingValue.totalDrawMoney : "0" }}</span>
                            </div>
                            <div class="flex items-center gap-[.1rem]">
                                <span class="flex items-center text-[#fff] text-[.2rem]">Balance</span>
                                <span class="flex items-center text-[#fff] text-[.2rem]">{{ financingValue.totalMoney ?
                                    financingValue.totalMoney : "0" }}</span>
                            </div>
                        </div>

                    </div>
                </div>
                <div v-if="FinancingData?.content?.rows?.length == 0"
            ...
            <div class="flex gap-[.2rem]">
                <div class="flex flex-col gap-[.1rem] w-fit leading-none">
                    <div class="flex gap-[.5rem] items-center">
                        <div class="flex items-center text-nowrap"><span class="text-[.2rem] text-white">Total recharge
                                amount</span></div>
                    </div>
                    <div class="flex gap-[.5rem] items-center">
                        <div class="flex items-center text-nowrap"><span class="text-[.2rem] text-white">The number of
                                deposits</span></div>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-[.1rem] leading-none">
                    <div class="flex gap-[.5rem] items-center">
                        <div class="flex items-center"><span class="text-[.2rem] text-white">{{
                            FinancingData?.content?.aggsData?.directTotalDeposit ?
                                FinancingData?.content?.aggsData?.directTotalDeposit : 0 }}</span></div>
                    </div>
                    <div class="flex gap-[.5rem] items-center">
                        <div class="flex items-center"><span class="text-[.2rem] text-white">{{
                            FinancingData?.content?.aggsData?.directDepositTimes ?
                                FinancingData?.content?.aggsData?.directDepositTimes : 0 }}</span></div>
                    </div>
                </div>
            </div>
            <div class="flex gap-[.2rem]">
                <div class="flex flex-col gap-[.1rem] leading-none">
                    ...
                    <div class="flex gap-[.5rem] items-center">
                        <div class="flex items-center text-nowrap"><span class="text-[.2rem] text-white">Number of
                                direct registered persons</span></div>
                    </div>
                </div>
                <div class="flex flex-col gap-[.1rem] leading-none">
                    <div class="flex gap-[.5rem] items-center">
                        <div class="flex items-center"><span class="text-[.2rem] text-white">{{
                            FinancingData?.content?.aggsData?.directTotalDraw ?
                                FinancingData?.content?.aggsData?.directTotalDraw : 0 }}</span></div>
                    </div>
                    <div class="flex gap-[.5rem] items-center">
                        <div class="flex items-center"><span class="text-[.2rem] text-white">{{
                            FinancingData?.content?.aggsData?.directRegCount ?
                                FinancingData?.content?.aggsData?.directRegCount : 0 }}</span></div>
                    </div>
                </div>
            </div>
        </div>
