                    ...
                    <div className="mainContentContainer">
                        <div className="sideButtonsContainer">
                            <Stack spacing={2} direction="column">
                                ...
                                <Link to="/core-wallet-blockchain"><Button variant='contained' className="sideButtons active">Blockchain</Button></Link>
...
export default CoreWalletBlockchain