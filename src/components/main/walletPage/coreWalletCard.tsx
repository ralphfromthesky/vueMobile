                    ...
                    <div className="mainContentContainer">
                        <div className="sideButtonsContainer">
                            <Stack spacing={2} direction="column">
                                <Link to="/core-wallet-card"><Button variant='contained' className="sideButtons active">Card</Button></Link>
                                <Link to="/core-wallet-arcade"><Button variant='contained' className="sideButtons">Arcade</Button></Link>
                                <Link to="/core-wallet-fishing"><Button variant='contained' className="sideButtons">Fishing</Button></Link>
                            ...
                            <div className="searchBarContainer">
                                <FormControl sx={{ m: 1, width: '100%' }} variant="outlined">
                                    <OutlinedInput
                                        ...
                                        endAdornment={<InputAdornment position="end"><SearchIcon fontSize="large"></SearchIcon></InputAdornment>}
