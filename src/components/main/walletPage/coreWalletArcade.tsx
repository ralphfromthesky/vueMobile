                    ...
                    <div className="mainContentContainer">
                        {/* <div className="sideButtonsContainer">
                            <Stack spacing={2} direction="column">
                                ...
                                <Link to="/core-wallet-arcade"><Button variant='contained' className="sideButtons active">Arcade</Button></Link>
...
export default CoreWalletArcade