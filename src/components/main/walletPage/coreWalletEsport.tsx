                    ...
                    <div className="mainContentContainer">
                        <div className="sideButtonsContainer">
                            <Stack spacing={2} direction="column">
                                ...
                                <Link to="/core-wallet-esport"><Button variant='contained' className="sideButtons active">E-sport</Button></Link>
                            </Stack>
                        </div>
...
export default CoreWalletEsport